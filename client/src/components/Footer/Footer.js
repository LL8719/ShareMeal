...
export default function Footer() {
    ...
    return <Box as="footer">
        <Stack direction="horizontal">
            ...
            <Box display="flex" gap="20px" w="95%" alignItems="center" justifyContent={"space-between"}>

                <Box display={"flex"}>
                    <IconButton margin='8px' colorScheme='teal' aria-label='instagram' icon={<MdFoodBank />} />
